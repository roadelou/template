...
struct MatchList {
    ...
    size_t *head; ///< The array of start positions of the format specifier in
                  ///< the text. This will be the position of the intial `%`.
    size_t
        *tail; ///< The array of last positions of the format specifier in the
               ///< text. This will be the position of the terminating `$`,
               ///< where `$` is the character which followed the leading `%`.
};
